...
create table pedidos(
    ...
    constraint fk_pedGar foreign key (idGar) references garcons(idFun),
...
insert into funcionarios(idFun, salario, situacao, nome) values (1, 3000, 'Ativo', 'Master chefe'), (2, NULL, 'Aposentado', 'Mario Verde'), (3, 1000, 'Ativo', 'Mario Mario'), (4, NULL, 'Estagiario', 'Luigi Mario');
insert into garcons(idFun) values (1), (2);
insert into cozinheiros (idFun, idChefe) values (3, NULL), (4, 3);
insert into pedidos (idPed, situacao, idCli, idGar, dataPed) values (1, 'pendente', 2000, 1, CURDATE()), (2, 'pago', 2000, 2, CURDATE());
